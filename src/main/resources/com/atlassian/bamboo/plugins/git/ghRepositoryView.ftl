...
[@ww.label labelKey='repository.github.repository' value=repository.repository?html /]
[@ww.label labelKey='repository.github.branch' value=repository.branch!?html hideOnNull=true /]
